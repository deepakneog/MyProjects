...
<div id="wrapper">
    ...
    <h1><a href="index.php"></a></h1>
        <ul id="mainnav">
			<li class="current"><a href="index.php" style="font-size: small"><strong>Home</strong></a></li>
            <li></li>
    	</ul>
	</div>
    <div id="content">
    	<div id="rotator">
			  ...
			  <div id="logo" style="left: 825px; height: auto; top: 165px; width: 260px; position: absolute; z-index: 4;">
					...
					<div class="accordion-content" style="margin-bottom: 15px;">
						...
						<span style="margin-right: 11px;color:#666"><label> Username: <span style="font-weight:bolder"</span> </label><input type="text" name="u_name" style="width: 165px; margin-left: 15px; border: 3px double #CCCCCC; padding:5px 10px;"/></span><br>
	...
	<p style="color: #FFFFFF">PIN: 785001</p>
